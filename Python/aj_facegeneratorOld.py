...
class FaceGenerator(aj_speechprocessor.Speechprocessor) :
    ...
    '''
    Process speech and generate faces array
    1. Find peaks of sound file
    2. Find Gradient descent to obtain start, peak, end
    3. Get amplitude of start, peak, end
    4. Get fundamental frequency of start, peak, end
    5. Get notes of start, peak, end
    6. Get closest match from aj_globavar.allSpeechNotesArray of speech note
    7. Obtain face data from aj_globalvar
    8. Piece face data together peak by peak
    '''
