...
def v3FromVertex(vertex):
    return array((vertex[0], vertex[1], vertex[2]), dtype=FLOAT)
...
def v4FromVertex(vertex):
    return array((vertex[0],vertex[1],vertex[2],0.0), dtype=FLOAT)
